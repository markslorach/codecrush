...
export default function MobileNav() {
  ...
  return (
    <nav className="pb-8 pt-12 fixed z-30 bottom-0 left-0 w-full bg-gradient-to-t from-slate-900 md:hidden">
      <div className="max-w-md mx-auto h-full flex justify-center items-center px-5 sm:px-10">
        <div className="bg-slate-800 w-5/6 h-min py-4 px-6 rounded-xl shadow-md">
